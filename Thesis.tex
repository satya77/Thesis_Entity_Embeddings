...
\newacronym[description={GloVe model on raw data }]  {$r$GLV}{$r$GLV}{GloVe model on raw data}
\newacronym[description={GloVe model on annotated data }]  {$a$GLV}{$a$GLV}{GloVe model on annotated data}
