...
\draw (165,64) node   {$b$};
\draw (163,101) node   {$\theta_{1}$};
\draw (162,145) node   {$\theta_{2}$};
\draw (156,187) node   {$\theta_{3}$};
\draw (482,146) node   {$a=\hat{y}$};
\draw (322,141) node [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ]  {$g( z)$};
\draw (267,142) node [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ]  {$\Theta ^{T} x+b$};
\draw (273,185) node   {$z$};
\draw (322,179) node   {$a$};
