...
\draw (60,106) node [scale=0.9] [align=left] {$e (\textcolor[rgb]{0.29,0.56,0.89}{\mathrm{ACT}}\textcolor[rgb]{0.29,0.56,0.89}{_{1}} ,\mathrm{TER_{1}})$};
\draw (181,36) node [scale=0.7,color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ]  {$\mathrm{ACT_{1}}$};
...
\draw (67,332) node  [align=left] {$e(\textcolor[rgb]{0.29,0.56,0.89}{\mathrm{LOC}}\textcolor[rgb]{0.29,0.56,0.89}{_{1}} ,\mathrm{TER_{1}})$};
\draw (190,283) node [scale=0.7,color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ]  {$\mathrm{LOC_{1}}$};
\draw (185,402) node [scale=0.7]  {$\mathrm{TER_{1}}$};
...
\draw (81,207) node [scale=0.7,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ]  {$\mathrm{TER_{1}} \ embedding\ for\ all\ actors$};
\draw (83,448) node [scale=0.7,color={rgb, 255:red, 82; green, 21; blue, 168 }  ,opacity=0.88 ]  {$\mathrm{TER_{1} }\ embedding\ for\ all\ locations$};
\draw (590,239) node  [align=left] {...};
\draw (443,104) node  [align=left] {$-\ log( e (\textcolor[rgb]{0.29,0.56,0.89}{\mathrm{ACT}}\textcolor[rgb]{0.29,0.56,0.89}{_{1}} ,\mathrm{TER_{1}}))$};
\draw (593,355) node  [align=left] {$loss(\textcolor[rgb]{0.29,0.56,0.89}{\mathrm{LOC_{1}}} ,\mathrm{TER_{1}})$};
\draw (456,332) node  [align=left] {$-\ log( e (\textcolor[rgb]{0.29,0.56,0.89}{\mathrm{LOC_{1}}} ,\mathrm{TER_{1}}))$};
