...
\item  $f=\mathrm{sqr}$, square root of each edge weight is computed. But since it produced similar results to logarithmic normalization, it is removed from the results.\\
\end{inparaenum}
\noindent
